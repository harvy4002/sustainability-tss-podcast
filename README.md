...
## 🚀 Technical Overview for Handover

### 1. Architecture
- **Backend:** Google Cloud Functions (Gen 2) using Node.js 20.
- **Storage:** Google Cloud Storage (GCS) bucket `sustainability-podcast` stores the MP3 files, the RSS feed (`feed.xml`), and the landing page (`index.html`).
...
### Adding a Logo
The site expects a logo at `gs://sustainability-podcast/logo.png`. To update it:
```bash
gcloud storage cp your-logo.png gs://sustainability-podcast/logo.png
```
...
## 🔗 Links
- **Public Site:** [https://storage.googleapis.com/sustainability-podcast/index.html](https://storage.googleapis.com/sustainability-podcast/index.html)
- **RSS Feed:** [https://storage.googleapis.com/sustainability-podcast/feed.xml](https://storage.googleapis.com/sustainability-podcast/feed.xml)
