...
config.podcast.siteUrl = 'https://storage.googleapis.com/sustainability-podcast-data';
...
async function regenerate() {
  ...
  // 2. Build episodes list directly from cache
  const episodes = [];
  ...
  console.log('gcloud storage cp feed.xml gs://sustainability-podcast-data/feed.xml');
  console.log('gcloud storage cp index.html gs://sustainability-podcast-data/index.html');
  console.log('----------------------------------------');
}
